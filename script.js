...
function parseReferences() {
    ...
    try {
        ...
        if (overlappingDescriptions.length > 0) {
            ...
            console.warn('标记名称重叠:', overlappingDescriptions);
            showNotification(`检测到 ${overlappingDescriptions.length} 组标记名称重叠，将按最长匹配原则处理`, 'warning');
